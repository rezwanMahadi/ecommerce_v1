...
export default function OrdersPage() {
  ...
  // Sample orders data - in a real app, fetch from API
  const orders = [
    {
      id: 'ORD-1234',
      customer: 'John Doe',
  ...
  // Status badge styles
  const getStatusBadgeClass = (status: 'completed' | 'processing' | 'shipped' | 'cancelled' | string) => {
    switch(status) {
      case 'completed':
              ...
              {filteredOrders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button className="text-indigo-600 hover:text-indigo-900 flex items-center justify-end space-x-1">
